...
export default function UserProfile(profileResult: ProfileResult) {
    ...
    return (
        <div className={"w-full  bg-blue-50 md:p-10 sm:p-0"}>
            <span className={'text-4xl font-montserratThin md:justify-start flex justify-center opacity-60'}>Profile</span>
            <div className={'flex flex-wrap flex-col md:flex-row gap-4'}>
                {/*{USER TEMPLATE}*/}
                    <ProfileForm {...profileResult} />
                {/*{SkillS TEMPLATE}*/}
                <div className={'flex flex-wrap 2xl:h-40 h-40 gap-5 rounded w-full md:w-1/3 p-5 bg-white mt-2 overflow-y-scroll'}>
